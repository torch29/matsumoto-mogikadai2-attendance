...
class AttendanceCorrectionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rest_corrections.*.corrected_rest_start' => 'nullable' | 'date_format:H:i' | 'after_or_equal:corrected_clock_in' | 'before:corrected_clock_out',

            'rest_corrections.*.corrected_rest_end' => 'nullable' | 'date_format:H:i' | 'after:corrected_rest_start' | 'before:corrected_clock_out',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'corrected_clock_in.date_format' => '半角数字で X:XX 形式で入力してください。',
            'corrected_clock_out.date_format' => '半角数字で X:XX 形式で入力してください。',
