        ...
        <form action="/correction_request" class="detail-form" method="post">
            ...
            <table class="detail-table">
                ...
                <tr class="detail-table__row">
                    ...
                    <td class="detail-table__data-left">
                        <input type="text" class="detail-table__input" name="rest_corrections[{{ $i }}][corrected_rest_start]" value="{{ old("rest_corrections.$i.corrected_rest_start", $rest->rest_start->isoFormat('H:mm')) }}">　～
                    </td>
                    <td class="detail-table__data">
